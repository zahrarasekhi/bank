...
namespace MyContacts
{
    class ContactsRepository : IContactsRepository
    {
        ...
        private string connectionString = "Data Source=ZAHRA\\SQL2019;Initial Catalog=Contact_DB;Integrated Security=true";
        ...
        {
            SqlConnection connection = new SqlConnection(connectionString);
            string query = "Select * From MyContacts where Name Like N'@parameter' Family Like N'@parameter'";
            SqlDataAdapter adapter = new SqlDataAdapter(query, connection);
